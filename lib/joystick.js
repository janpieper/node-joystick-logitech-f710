...
Joystick.create("/dev/input/js0", function (joystick) {
  joystick.on("button:1:press", function () {
    console.log("button 1 pressed");
  });

  joystick.on("error", function () {
    console.log("joystick caused an error");
  });

  joystick.on("close", function () {
    console.log("joystick closed");
  });
});
*/
...
var originalEmit = Joystick.prototype.emit;
Joystick.prototype.emit = function (eventName, a, b, c) {
